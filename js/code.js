...
function myFunctionTest(expected, function2test) {
  ...
  let teacher1 = new Person("Wagobera");
  ...
  //Question One Test case
  console.log("Expected output of teach() is  'Wagobera is now teaching English'  " + myFunctionTest('Wagobera is now teaching English', function () {
  ...
  //Question One Test case
  console.log("Expected output of teach() is  'Wagobera is now teaching Mathematics'  " + myFunctionTest('Edgar Wagobera is now teaching Mathematics', function () {
  ...
  //TEST CASES
  let Student1 = new Student("Wagobera Edgar", 12, "Computer Science");
  //Student greeting test case
  console.log("Expected output of Student1.greeting() is  'Hey, my name is Wagobera Edgar and I am studying  Computer Science'  " + myFunctionTest('Hey, my name is Wagobera Edgar and I am studying  Computer Science', function () {
  ...
  //TEST CASES
  //Student greeting test case
  console.log("Expected output of Student.greeting('Computer Science'); is  'Hey, my name is Wagobera Edgar and I am studying  Computer Science'  " + myFunctionTest('Hey, my name is Edgar Wagobera and I am studying  Computer Science', function () {
